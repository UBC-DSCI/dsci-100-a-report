...
.center[`dsci-data`: a common access point for DSCI-coded course datasets]

**Usage:** `data <- dscidata('your-dataset')`

--

**Advantages:**
- better reproducibility
	- documented cleaning, data provenance, citability, metadata
- lower workload for students, professors
	- no course-specific finding / cleaning data
- extendable, "open data borders"
- tailored for pedagogical use

--

**Future Goals:**
- expand to STAT-coded courses, beyond
- search functionality
	- field-of-study, model type, size
- access large datasets in small chunks ("big data API")
