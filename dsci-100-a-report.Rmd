...
subtitle: "A report on its first offering and future directions"
author: "Tiffany Timbers & Trevor Campbell"
institute: "University of British Columbia"
date: "2019/08/02 (updated: `r Sys.Date()`)"
output:
...
- Recognize when a data science problem can be solved by predicting labels (classification), predicting values (regression) or identifying sub groups within the data (clustering)
